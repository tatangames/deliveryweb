...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ URL::to('/admin/cupones/lista/tabla/zonas') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/cupones/lista/tabla/zonas') }}";
            $('#tablaDatatable').load(ruta);
        }
        ...
        function nuevo(){
            ...
            axios.post('/admin/cupones/zona/agregar', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function borrar(){
            ...
            openLoading();
            axios.post('/admin/cupones/zona/borrar',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function borrarTodo(){
            ...
            openLoading();
            axios.post('/admin/cupones/zona/borrar-global',{
                'id': 0
            })
                .then((response) => {
                    closeLoading();

...
<section class="content-header">
    <div class="container-fluid">
        <div class="col-sm-12">
            <h1>Lista de Cupones para Productos</h1>
        </div>
        <br>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="100" class="form-control" id="producto">
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Producto</label>
                                    <input type="text" maxlength="100" class="form-control" id="producto-editar">
                                </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            var ruta = "{{ url('/admin/cupon/lista/tabla/producto') }}";
    ...
    <script>
        ...
        function informacion(id){
            ...
            axios.post('/admin/cupon/lista/producto-informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
                        ...
                        $('#producto-editar').val(response.data.lista.nombre);
                    }else{
        ...
        function nuevo(){
            var cupon = document.getElementById('select-producto').value;
            ...
            if(producto === ''){
                toastMensaje('error', 'Nombre Producto es requerido');
                return;
            }

            if(producto.length > 100){
                toastMensaje('error', 'Máximo 100 caracteres para Producto');
                return;
            }
            ...
            axios.post('/admin/cupon/lista/producto-nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post('/admin/cupon/lista/producto-editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if (response.data.success === 1) {
        ...
        function borrar(){
            ...
            openLoading();
            axios.post('/admin/cupon/lista/producto-borrar',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
